...
using Euler2D: computation_region_indices, computation_region, step_cell_simulation!
...
obstacle = [CircularObstacle((0.0, 0.0), 1.0)]
ncells = (100, 100)
...
compute_cell_update_and_max_Δt(cell1, active_cells, bcs, DRY_AIR)
...
step_cell_simulation!(test_partition, 0.1, bcs, 0.8, DRY_AIR)
