...
Euler2D.simulate_euler_equations_cells(
    ...
    write_frequency = 75,
    max_tsteps = 20000,
    output_tag = "circular_obstacle_tangent_longtime",
...
Euler2D.simulate_euler_equations_cells(
    ...
    write_frequency = 75,
    max_tsteps = 20000,
    output_tag = "circular_obstacle_density_perturbed_longtime",
    output_channel_size = 4,
    tasks_per_axis = 4,
);
...
Euler2D.simulate_euler_equations_cells(
    ...
    write_frequency = 75,
    max_tsteps = 20000,
    output_tag = "circular_obstacle_minf_perturbed_longtime",
    output_channel_size = 4,
    tasks_per_axis = 4,
);