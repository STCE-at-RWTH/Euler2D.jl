...
x_circ = (t, params) -> params.h + params.r * cos(t)
y_circ = (t, params) -> params.k + params.r * sin(t)
params_circ = (r = 0.75, h = 0.0, k = 0.0)
just_circle = [ParametricObstacle(x_circ, y_circ, params_circ, :circle)]
ncells = (100, 150)
