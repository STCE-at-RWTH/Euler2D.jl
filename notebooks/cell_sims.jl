...
# ╔═╡ e2fb0b84-1a69-4c0f-8536-ad9a81d24835
struct CellSim{T}
	n_tsteps::Int
	n_active::Int
	n_cells::Tuple{Int, Int}
	active_ids::Array{Int, 2}
...
function plotframe(frame, esim)
	u_k = @view esim.u[:, :, frame]
	(xs, ys) = map(zip(esim.bounds, esim.n_cells)) do (b, n)
		r = range(b...; length=n+1)
...
manifest_format = "2.0"
project_hash = "3d8edbbb84a9d890713aa55e4a6373515e28a371"
